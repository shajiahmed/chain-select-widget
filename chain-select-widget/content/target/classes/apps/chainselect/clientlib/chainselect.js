...
ExperienceAEM.ChainSelect = CQ.Ext.extend(CQ.Ext.Panel, {
    ...
    setValue: function (value) {
        ...
        var lData = this.getDropDownData({ levels : levels, keywords: keywords, data: this.data });
    ...
    getDropDownData: function(params){
        if(!params){
            params = { level : 1, keyword: "" , data : this.data}
        }
            ...
            this.add(new CQ.Ext.form.ComboBox({
                ...
                listeners:{
                    ...
                    select: function(combo){
                        ...
                        lData = this.getDropDownData({ level : combo.level + 1, keyword: keyword , data: this.data});
